...
namespace Métodos_para_arrays__Parte1____Aula_23
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("EElementos do vetor 1: ");
            ...
            Console.WriteLine("O valor {0} esta na posição {1}",procurado,pos);
            Console.WriteLine("------------------------------------------");

            //public void copy(ar_origem,Ar_destinoqtd_elementos);

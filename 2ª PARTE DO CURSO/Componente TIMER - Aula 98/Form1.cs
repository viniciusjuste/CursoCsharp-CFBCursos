...
namespace Componente_Backgroundworker____Aula_97
{
    public partial class Form1 : Form
    {
        ...
        private void componenteTimerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            F_Timer f_Timer = new F_Timer();
            f_Timer.ShowDialog();
        }

        private void backgroundWorkToolStripMenuItem_Click(object sender, EventArgs e)
        {
